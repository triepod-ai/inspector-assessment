 ...
 * @see patterns/annotation-patterns.json
 *
...
import { getRawAnnotationPatterns } from "../patterns";
 ...
 *
 * Pattern data is loaded from patterns/annotation-patterns.json
 * @see patterns/annotation-patterns.json for the actual pattern values
 */
