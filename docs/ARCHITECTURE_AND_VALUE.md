...
2. **11 automated assessment modules** - Security, functionality, documentation, and more
...
Inspector's 11 modules are mapped to mcp-auditor's 5 categories:
...
| ----------------------- | ---------------------------------- | ------------------------------------------- |
| **Audit Quality**       | 11 automated modules, quantitative | Fallback 50% scores, "manual review needed" |
...
- [ASSESSMENT_CATALOG.md](ASSESSMENT_CATALOG.md) - Complete 11-module reference
